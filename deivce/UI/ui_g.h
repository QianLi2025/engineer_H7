...
#define ui_g_Ungroup_rxy_index ((ui_interface_round_t*)&(ui_g_now_figures[9]))
#define ui_g_Ungroup_SOURCELine1 ((ui_interface_line_t*)&(ui_g_now_figures[10]))
#define ui_g_Ungroup_SOURCELine2 ((ui_interface_line_t*)&(ui_g_now_figures[11]))
#define ui_g_Ungroup_SILVERLine ((ui_interface_line_t*)&(ui_g_now_figures[12]))
...
#define ui_g_Ungroup_rxy_index_dirty (ui_g_dirty_figure[9])
#define ui_g_Ungroup_SOURCELine1_dirty (ui_g_dirty_figure[10])
#define ui_g_Ungroup_SOURCELine2_dirty (ui_g_dirty_figure[11])
#define ui_g_Ungroup_SILVERLine_dirty (ui_g_dirty_figure[12])
