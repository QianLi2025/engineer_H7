...
void ui_init_g() {
    ui_g_Ungroup_REAL_HEIGHT->figure_type = 6;
    ui_g_Ungroup_REAL_HEIGHT->operate_type = 1;
    ...
    ui_g_Ungroup_SILVER2_LOCATION->figure_type = 0;
    ui_g_Ungroup_SILVER2_LOCATION->operate_type = 1;
    ...
    ui_g_Ungroup_SOURCE_HEIGHT->figure_type = 0;
    ui_g_Ungroup_SOURCE_HEIGHT->operate_type = 1;
    ...
    ui_g_Ungroup_BOUNDARY_rec->figure_type = 1;
    ui_g_Ungroup_BOUNDARY_rec->operate_type = 1;
    ...
    ui_g_Ungroup_rxy_index->figure_type = 2;
    ui_g_Ungroup_rxy_index->operate_type = 1;
    ...
    ui_g_Ungroup_SOURCELine1->figure_type = 0;
    ui_g_Ungroup_SOURCELine1->operate_type = 1;
    ...
    ui_g_Ungroup_SOURCELine2->figure_type = 0;
    ui_g_Ungroup_SOURCELine2->operate_type = 1;
    ...
    ui_g_Ungroup_SILVERLine->figure_type = 0;
    ui_g_Ungroup_SILVERLine->operate_type = 1;
    ...
    ui_g_Ungroup_HEIGHT_LINE->figure_type = 0;
    ui_g_Ungroup_HEIGHT_LINE->operate_type = 1;
    ...
    ui_g_Ungroup_ARROW1->figure_type = 0;
    ui_g_Ungroup_ARROW1->operate_type = 1;
    ...
    ui_g_Ungroup_ARROW2->figure_type = 0;
    ui_g_Ungroup_ARROW2->operate_type = 1;
    ...
    ui_g_Ungroup_heigth_index->figure_type = 2;
    ui_g_Ungroup_heigth_index->operate_type = 1;
    ...
    ui_g_Ungroup_SUCKER->figure_type = 7;
    ui_g_Ungroup_SUCKER->operate_type = 1;
    ...
    ui_g_Ungroup_SUCKER_STATE->figure_type = 7;
    ui_g_Ungroup_SUCKER_STATE->operate_type = 1;
    ...
    ui_g_Ungroup_AUTO_STATE->figure_type = 7;
    ui_g_Ungroup_AUTO_STATE->operate_type = 1;
    ui_g_Ungroup_AUTO_STATE->layer = 0;
    ui_g_Ungroup_AUTO_STATE->color = 2;
    ui_g_Ungroup_AUTO_STATE->start_x = 763;
    ui_g_Ungroup_AUTO_STATE->start_y = 204;
    ui_g_Ungroup_AUTO_STATE->width = 2;
    ui_g_Ungroup_AUTO_STATE->font_size = 20;
    ui_g_Ungroup_AUTO_STATE->str_length = 10;
    strcpy(ui_g_Ungroup_AUTO_STATE->string, "AUTO_STATE");

    ui_g_Ungroup_AUTO_STATE_TEXT->figure_type = 7;
    ui_g_Ungroup_AUTO_STATE_TEXT->operate_type = 1;
    ui_g_Ungroup_AUTO_STATE_TEXT->layer = 0;
    ui_g_Ungroup_AUTO_STATE_TEXT->color = 8;
    ui_g_Ungroup_AUTO_STATE_TEXT->start_x = 1040;
    ui_g_Ungroup_AUTO_STATE_TEXT->start_y = 204;
    ui_g_Ungroup_AUTO_STATE_TEXT->width = 2;
    ui_g_Ungroup_AUTO_STATE_TEXT->font_size = 20;
    ui_g_Ungroup_AUTO_STATE_TEXT->str_length = 6;
    strcpy(ui_g_Ungroup_AUTO_STATE_TEXT->string, "HANDLE");

    ui_g_Ungroup_ROBOT->figure_type = 7;
    ui_g_Ungroup_ROBOT->operate_type = 1;
    ...
    ui_g_Ungroup_ROBOT_STATE->figure_type = 7;
    ui_g_Ungroup_ROBOT_STATE->operate_type = 1;
    ...
    ui_g_Ungroup_HEIGHT_NAME->figure_type = 7;
    ui_g_Ungroup_HEIGHT_NAME->operate_type = 1;
